...
static ssize_t gt9xx_ts_enable_dt2w_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
...
static ssize_t gt9xx_ts_enable_dt2w_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int i;
...
static DEVICE_ATTR(enable_dt2w, S_IWUSR | S_IRUSR, gt9xx_ts_enable_dt2w_show,
					gt9xx_ts_enable_dt2w_store);
